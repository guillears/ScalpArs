    ...
    try:
        ...
        for p in _ps:
            ...
            rows.append({
                ...
                'blk_sp': p.blocked_spacing or 0, 'blk_sl': p.blocked_slots or 0, 'blk_ema': p.blocked_ema50 or 0, 'blk_24h': getattr(p, 'blocked_off24h', 0), 'blk_e13': getattr(p, 'blocked_ema13', 0) or 0, 'blk_pvr': getattr(p, 'blocked_pvr', 0) or 0, 'blk_1h': getattr(p, 'blocked_1h', 0) or 0, 'blk_br': getattr(p, 'blocked_breadth', 0) or 0,
