...
def main():
    ...
    # Sep-25 (DECISION_LOG 116): heat block re-scoped to breadth only — BTC legs 0 (off), bull 80 → 85, washed-out exemption kept
    _HEAT_TH = SimpleNamespace(long_heat_block_enabled=True, long_heat_btc_slope_min=0.0, long_heat_btc_rsi_prev_min=0.0,
                               long_heat_bull_pct_min=85.0, long_heat_exempt_off30d_max=-10.0,
